...
Programming languages are different levels of abstraction of binary, the ones and zeroes that make up the computer's language. Commands to the computer are written in a particular language and then compiled into binary.
